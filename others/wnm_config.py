...
wnm_pd_6T = pd.read_csv('../sim_6TSRAM/wnm_table.csv')

lin_plot(x=[[1, 2, 3, 4]], y=[wnm_pd_6T.values[:,1]], c=['r', 'k'], s=['solid'], m=['o'],\
         ylim=[0.2, 0.3], xticklabels=['111', '112', '123', '122'], yticks=[0.2, 0.25, 0.3], ms=20, lw=4.5,\
            xlabel='#fins (PU, PG, PD)', ylabel='WNM (V)')