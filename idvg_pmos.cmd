# CFET-BEOL SRAM at 2nm --> Si PMOS sdevice simulations of transfer curve at 0.01V and 0.7V |V_DS| 
...
Device NSFET {
	File {*input files
		...
		Doping = "nanosheet_ns2_2D_PMOS_msh.tdr"
      	      *output files
		Plot = "nanosheet_ns2_2D_PMOS_idvg_post.tdr"
		Current = "nanosheet_ns2_2D_PMOS_idvg.plt"
		Parameter = "models.par"
	     }
   	      
	Electrode{
        {Name="Gate" Voltage=0.0 Workfunction=4.75} 
	...
	Physics (Material="Metal"){
	    MetalWorkfunction ( Workfunction=4.75 )
	}
