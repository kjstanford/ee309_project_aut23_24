...
*                         general                          *
************************************************************
+version = 107             bulkmod = 0               igcmod  = 1               igbmod  = 0             
+gidlmod = 0               iimod   = 0               geomod  = 1               rdsmod  = 0             
+rgatemod= 0               rgeomod = 0               shmod   = 0               nqsmod  = 0             
+coremod = 0               cgeomod = 0               capmod  = 0               tnom    = 25            
+eot     = 1e-009          eotbox  = 1.4e-007        eotacc  = 1e-010          tfin    = 7e-009      
+toxp    = 2.1e-009        nbody   = 1e+022          phig    = 4.45            epsrox  = 3.9           
+epsrsub = 11.9            easub   = 4.05            ni0sub  = 1.1e+016        bg0sub  = 1.17          
+nc0sub  = 2.86e+025       nsd     = 1e+027          ngate   = 0               nseg    = 5             
+l       = 1.4e-008        xl      = 0e-009          lint    = -3e-009         dlc     = 0             
+dlbin   = 0               hfin    = 1.5e-008        deltaw  = 0               deltawcv= 0             
+sdterm  = 0               epsrsp  = 3.9           
+toxg    = 1.80e-009
************************************************************
*                            dc                            *
...
+rgatemod= 0               rgeomod = 0               shmod   = 0               nqsmod  = 0             
+coremod = 0               cgeomod = 0               capmod  = 0               tnom    = 25            
+eot     = 1e-009          eotbox  = 1.4e-007        eotacc  = 3e-010          tfin    = 7e-009      
+toxp    = 2.1e-009        nbody   = 1e+022          phig    = 4.78            epsrox  = 3.9           
+epsrsub = 11.9            easub   = 4.05            ni0sub  = 1.1e+016        bg0sub  = 1.17          
+nc0sub  = 2.86e+025       nsd     = 1e+027          ngate   = 0               nseg    = 5             
+l       = 1.4e-008        xl      = 0e-009          lint    = -4.5e-009       dlc     = 0             
+dlbin   = 0               hfin    = 1.5e-008        deltaw  = 0               deltawcv= 0             
+sdterm  = 0               epsrsp  = 3.9           
+toxg    = 1.95e-009
************************************************************
...
+nc0sub  = 2.86e+025       nsd     = 1e+027          ngate   = 0               nseg    = 5             
+l       = 1.4e-008        xl      = 0e-009          lint    = -3e-009         dlc     = 0             
+dlbin   = 0               hfin    = 3.6e-008        deltaw  = 0               deltawcv= 0             
+sdterm  = 0               epsrsp  = 3.9           
+toxg    = 1.80e-009
************************************************************
*                            dc                            *
