...
def spice_netlist(fname, params):
...
ax1.plot(lis_t*1e9, lis_vwwl, linewidth=4, color='r')
ax2.plot(lis_t*1e9, lis_vwbl, linewidth=4, color='b')
ax2.plot(lis_t*1e9, lis_vwblb, linewidth=4, color='r')
ax3.plot(lis_t*1e9, lis_vn1, linewidth=4, color='r')
ax3.plot(lis_t*1e9, lis_vn2, linewidth=4, color='r')
ax1.set(ylabel='$WWL(V)$')
ax1.set(ylim=[-0.1, 0.8])
ax1.set(yticks=[0, 0.7])
ax2.set(ylabel='$WBL,WBLB(V)$')
