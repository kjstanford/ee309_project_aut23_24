...
(define file_name "nanosheet_ns2_PMOS")
(define wsh 0.015)
(define tgm 0.010)
(define tgox 0.0008)
(define tghk 0.0005)
...
(define A (sdegeo:create-cuboid (position (+ tgm tghk) lcsp (+ tgm tghk)) (position (- ttot (+ tstep tgm) tghk) (- ltot lcsp) (- wtot tgm tghk)) "Oxide" "GOXA1"))
(define B (sdegeo:create-cuboid (position (+ tgm tghk tgox) lcsp (+ tgm tghk tgox)) (position (- ttot (+ tstep tgm) tghk tgox) (- ltot lcsp) (- wtot tgm tghk tgox)) "Oxide" "GOXB1"))
(sdegeo:bool-subtract (list A B))
(define A (sdegeo:create-cuboid (position (+ (+ tgm tstep) tghk) lcsp (+ tgm tghk)) (position (- ttot tgm tghk) (- ltot lcsp) (- wtot tgm tghk)) "Oxide" "GOXA2"))
(define B (sdegeo:create-cuboid (position (+ (+ tgm tstep) tghk tgox) lcsp (+ tgm tghk tgox)) (position (- ttot tgm tghk tgox) (- ltot lcsp) (- wtot tgm tghk tgox)) "Oxide" "GOXB2"))
(sdegeo:bool-subtract (list A B))
...
(define A (sdegeo:create-cuboid (position 0 lc 0) (position ttot lcsp wtot) "Oxide" "SPSOXA"))
(define B1 (sdegeo:create-cuboid (position (+ tgm tghk tgox) lc (+ tgm tghk tgox)) (position (- ttot (+ tgm tstep) tghk tgox) lcsp (- wtot tgm tghk tgox)) "Oxide" "SPSOXB1"))
(define B2 (sdegeo:create-cuboid (position (+ (+ tgm tstep) tghk tgox) lc (+ tgm tghk tgox)) (position (- ttot tgm tghk tgox) lcsp (- wtot tgm tghk tgox)) "Oxide" "SPSOXB2"))
(sdegeo:bool-subtract (list A B1 B2))

(define A (sdegeo:create-cuboid (position 0 (- ltot lcsp) 0) (position ttot (- ltot lc) wtot) "Oxide" "SPDOXA"))
(define B1 (sdegeo:create-cuboid (position (+ tgm tghk tgox) (- ltot lcsp) (+ tgm tghk tgox)) (position (- ttot (+ tgm tstep) tghk tgox) (- ltot lc) (- wtot tgm tghk tgox)) "Oxide" "SPDOXB1"))
(define B2 (sdegeo:create-cuboid (position (+ (+ tgm tstep) tghk tgox) (- ltot lcsp) (+ tgm tghk tgox)) (position (- ttot tgm tghk tgox) (- ltot lc) (- wtot tgm tghk tgox)) "Oxide" "SPDOXB2"))
(sdegeo:bool-subtract (list A B1 B2))
